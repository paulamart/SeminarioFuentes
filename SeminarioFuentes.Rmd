...
Utilizamos tidyjson para poder importar ambos sets de datos en formato json.
...
Utilizamos rjson para poder leer los sets de datos que se encuentran en formato json.
...
#### 4.3.4. Filtrado para la Variación de suicidio respecto al sexo por años
...
#### 4.3.5. Filtrado para la Variación de suicidios respecto a los años, al sexo y a la Comunidad Autónoma
##### 4.3.5.1. Realización gráfica
...
#### 4.3.6. Filtrado para la relación entre paro y suicidio
...
##### 4.3.6.1. Cambio en los años del set de Tasa de paro
...
##### 4.3.6.2. Cambio en los años del set Suicidio
...
##### 4.3.6.3. Unión mediante un full join
...
###### 4.3.6.3.1.Renombrar columna "año"
...
###### 4.3.6.3.2. Representación gráfica
