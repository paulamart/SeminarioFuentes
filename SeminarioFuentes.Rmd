...
![Imagen 6. Noticia del suicidio en España en 2020](input/images/Noticia_Suicidio_2020.png)
En este mismo artículo, muestra la estadística, visualmente, del número de suicidios diarios
![Imagen 7. Número de suicidios en España en 2020](input/images/Noticia_Suicidios_diarios_2020.png)
...
![Imagen 8. Gráfico del suicidio respecto a Comunidad Autónoma](input/images/Suicidio_CCAA.png)
...
<https://www.huffingtonpost.es/entry/graficos-suicidio-espana_es_61b85b8de4b0358b5c4af1c5>
![Imagen 9. Comunidades donde hay el mayor número de suicidios](input/images/Noticia_Suicidio_comunidades_2020.png)
